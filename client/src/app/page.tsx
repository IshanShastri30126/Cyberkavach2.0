...
export default function LoginPage() {
  ...
  React.useEffect(() => {
    if (user && user.isApproved) router.push("/dashboard");
  }, [user, router]);
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="ck-input-icon-wrapper">
                        ...
                        <input type="text" placeholder="USER_IDENTIFIER" value={name} onChange={(e) => setName(e.target.value)} required={!isLogin} className="ck-input ck-input-with-icon" />
                      </div>
                    </div>
                    <div>
